...
<form method="POST" enctype="multipart/form-data" style="margin-top: 10px;">
    ...
    <div class="input-group mb-3">
     <input type="number" class="form-control" placeholder="Reduzir em %" aria-label="Recipient's username" aria-describedby="basic-addon2" name="qualidade" required>
...
?>
    ...
    <div class="alert alert-success">
        ...
        Sua imagem tinha <?php echo (int)$img['size'] ?>KB e agora tem <?php echo (int)$imgnova  ?>KB.
    </div>
